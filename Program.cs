...
namespace Phase1Section5._6
{
    public class Program
    {
        ...
        public static void runApp()
        {
            ...
            Console.WriteLine("Class Teacher: " + class1A.ClassTeacher.Name + " (Joined on " + class1A.ClassTeacher.DateOfJoining.ToShortDateString() + ")");
            Console.WriteLine("\nStudents:");
            foreach (var student in class1A.Students)
            {
                Console.WriteLine("- " + student.Name + " (" + student.GuardianName + ")");
            }
